class User < ActiveRecord::Base
  ...
  has_many :sub_articles , class_name: 'Article', primary_key: 'parent_id', dependent: :destroy
  has_many :evaluations, class_name: "RSEvaluation", as: :source
  has_and_belongs_to_many :fav_articles, join_table: :articles_users,class_name: 'Article', dependent: :destroy
